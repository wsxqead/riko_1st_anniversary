...
export default function RikoStats() {
  ...
  const chartData = [
    { name: "2024년 5월", 방송횟수: 10, 방송시간: 20 },
    { name: "2024년 6월", 방송횟수: 15, 방송시간: 25 },
    { name: "3월", 방송횟수: 12, 방송시간: 22 },
    { name: "4월", 방송횟수: 18, 방송시간: 30 },
    { name: "5월", 방송횟수: 20, 방송시간: 35 },
    { name: "6월", 방송횟수: 25, 방송시간: 40 },
    { name: "7월", 방송횟수: 22, 방송시간: 38 },
    { name: "8월", 방송횟수: 28, 방송시간: 42 },
    { name: "9월", 방송횟수: 30, 방송시간: 45 },
    { name: "10월", 방송횟수: 27, 방송시간: 40 },
    { name: "11월", 방송횟수: 23, 방송시간: 36 },
    { name: "12월", 방송횟수: 19, 방송시간: 32 },
  ];
              ...
              <ul className="text-white text-lg space-y-3">
                {songData.map((song, index) => (
                  <li key={index} className="flex items-center space-x-3">
                    <span className="text-2xl font-bold text-[#A6D0A6]">
                      {index + 1}.
                    </span>
