...
//         <ul className="text-gray-800 dark:text-white text-sm md:text-lg space-y-3 w-full md:w-auto">
//           {songData.map((song, index) => (
//             <li
//               key={index}
//               className="flex items-center space-x-3 hover:text-[#A6D0A6] transition-colors duration-200"
//             >
