export const timelineData = [
  ...
  },
  {
    ...
    events: [
      ...
      {
        date: "3월 29일",
        title: "월드 오브 탱크 부코 대전",
        description: "부키팀 VS 리코팀",
        icon: "🛡️",
        color: "bg-cyan-600",
      ...
      },
      {
        date: "5월 5일",
        title: "어린이날 기념 컨텐츠",
        description: "6살이 된 리코! 어린이날 기념 귀여운 방송",
        icon: "🎈",
        color: "bg-yellow-400",
      ...
      {
        date: "5월 5일",
        title: "스텔라이브 단체 9인 커버곡",
        description: "'Tell Your World' 단체 커버곡 영상 공개",
        icon: "🌎",
        color: "bg-indigo-500",
